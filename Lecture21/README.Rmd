...
criterion. 
First read the available dissimilarities, and arrange them in a
proper matrix:
```{r languages}
...
distances we obtain the following 3 clusters:
...
If we repeat the same exercise but using $L_1$ distances we get the following:
