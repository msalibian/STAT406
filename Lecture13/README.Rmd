...
in fact estimating the whole conditional distribution of $\mathbf{G}$
given $\mathbf{X} = \mathbf{x}_0$; 
in symbols: $\left. \mathbf{G} \, \right| \, \mathbf{X} = \mathbf{x}_0$.
...
model the distribution of $\mathbf{X} \, | \, \mathbf{G} = \mathbf{g}$
for each possible class $\mathbf{g}$). 
...
for $\mathbf{X} \, | \, \mathbf{G} = \mathbf{g}$
...
parameter estimates in $P( \mathbf{G} = \mathbf{g} \, | \, \mathbf{X})$ 
...
explanatory variables: $\mathbf{X} \, | \, \mathbf{G} = \mathbf{g} \, \sim \, N( \mathbf{\mu}, \mathbf{\Sigma})$. 
The second strongest assumption is
that of equal "shape" (in other words, that the covariance matrix
$\mathbf{\Sigma}$ above does not depend on $\mathbf{g}$). This latter assumption 
...
$\mathbf{X} \, | \, \mathbf{G} = \mathbf{g} \, \sim \, N( \mathbf{\mu}, \mathbf{\Sigma}_{\mathbf{g}})$.
